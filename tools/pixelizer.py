...
def process_airline_logos(
    logos_dir: str = "static/airline_logos",
...
Examples:
  ...
  %(prog)s --airline-logos --size 30
    ...
    parser.add_argument(
        "output",
        nargs="?",
        help="Output BMP file path (optional, auto-generated if not provided)",
    )
    parser.add_argument(
        "--airline-logos",
        action="store_true",
    ...
    if args.airline_logos:
        ...
        count = process_airline_logos(size=target_size, bg_color=bg_color)
